 ...
 * @author Julio
 */
@WebServlet(name = "HerramientasYFerreteria", urlPatterns = {"/HerramientasYFerreteria"})
public class HerramientasYFerreteria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet HerramientasYFerreteria</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet HerramientasYFerreteria at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    @Override
        ...
        //processRequest(request, response);
          NumeroCategoria N = new NumeroCategoria();
            int numero = N.GetCategoria("HerramientasYFerreteria");
    ...
    try{
        ...
        //nada haha
            ...
            request.getSession().setAttribute("Categoria","HerramientasYFerreteria");
