 ...
 * @author Julio
 */
@WebServlet(name = "Belleza", urlPatterns = {"/Belleza"})
public class Belleza extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Belleza</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Belleza at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
     ...
     protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //processRequest(request, response);
          NumeroCategoria N = new NumeroCategoria();
            int numero = N.GetCategoria("Belleza");
    ...
    try{
        ...
        //nada haha
            ...
            request.getSession().setAttribute("Categoria","Belleza");
