 ...
 * @author Julio
 */
@WebServlet(name = "Jardin", urlPatterns = {"/Jardin"})
public class Jardin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Jardin</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Jardin at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    @Override
     protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        NumeroCategoria N = new NumeroCategoria();
            int numero = N.GetCategoria("Jardin");
    ...
    try{
        ...
        //nada haha
            ...
            request.getSession().setAttribute("Categoria","Jardin");
