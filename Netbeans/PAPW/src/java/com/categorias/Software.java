 ...
 * @author Julio
 */
@WebServlet(name = "Software", urlPatterns = {"/Software"})
public class Software extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Software</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Software at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
       ...
       protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //processRequest(request, response);
          NumeroCategoria N = new NumeroCategoria();
            int numero = N.GetCategoria("Software");
    ...
    try{
        ...
        //nada haha
            ...
            request.getSession().setAttribute("Categoria","Software");
