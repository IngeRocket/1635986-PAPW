 ...
 * @author Julio
 */
@WebServlet(name = "BotonCancelar", urlPatterns = {"/BotonCancelar"})
public class BotonCancelar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BotonCancelar</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BotonCancelar at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
