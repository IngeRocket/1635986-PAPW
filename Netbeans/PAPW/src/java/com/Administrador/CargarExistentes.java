 ...
 * @author Julio
 */
@WebServlet(name = "CargarExistentes", urlPatterns = {"/CargarExistentes"})
public class CargarExistentes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CargarExistentes</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CargarExistentes at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
   ...
   List<String> ADMIN_PROD_Categoria = new ArrayList();
    ...
    comando.CargaExistentes(ADMIN_PROD_ID_Prod,ADMIN_PROD_Nombre,ADMIN_PROD_Stock,ADMIN_PROD_Precio,ADMIN_PROD_Borrador,ADMIN_PROD_Baja,ADMIN_PROD_Foto1,ADMIN_PROD_Foto2,ADMIN_PROD_Foto3,ADMIN_PROD_Video,ADMIN_PROD_Descripcion,ADMIN_PROD_Categoria);
    }catch(Exception EX){
        //nada haha
        }
